...
static class Program
{
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            var deviceLimit = GetIntArg(args, "--device-limit", isDev ? 5 : 250);
